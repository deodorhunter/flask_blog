...
def register():
    ...
    # create an instance of RegistrationForm, and save it in variable form
...
def user_posts(username):
    ...
    # paginate  returns a Pagination object, where you can set posts per page, number of pages
